    ...
    <div class="mycontent-wrap">
        ...
        <div class="title-column">
            ...
            <div class="upload-wrap">
                <el-upload class="upload-file" action="#" :before-upload="handle_before_upload" :http-request="upload_file" :show-file-list="false" :file-list="uploadFileList">
        ...
        <!-- 选择文件语言对话框 -->
        <el-dialog title="上传音视频文件" :visible.sync="uploadDialogVisible" width="40%" :before-close="handleUploadDialogClose">
        ...
        <!-- 文件列表 -->
        <el-table class="upload-table" :height="get_table_height()" :data="uploadTableData" style="width: 100%"  @row-click="handleUploadTableRowClick">
            <el-table-column type="selection" width="45" align="center"></el-table-column>
            <el-table-column prop="filename" label="文件">
                <template slot-scope="scope">
                    <div class="filename-wrap">
                        <div class="table-img">
                            <img src="../assets/img/audio.svg"></img>
                        </div>
            ...
            <el-table-column prop="operate" fixed="right" width="60" label="操作">
                <template slot-scope="scope">
                    <i class="el-icon-delete" @click="handleUploadFileDelete(scope.$index, scope.row)"></i>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        ...
        updateUploadStatusInfo(file_id, new_status_info) {
            ...
            for (var ii = 0; ii < that.uploadTableData.length; ii++) {
                if (that.uploadTableData[ii].file_id == file_id) {
                    that.uploadTableData[ii].upload_status_info =
                        new_status_info;
                }
            }
        },
                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        if (res.code != 0) {
                            ...
                            var upload_status_info =
                                that.convert_upload_status_info(
                                    res.status,
                                    res.duration
                                );
                            that.updateUploadStatusInfo(
                                file_id,
                                upload_status_info
                            );
        ...
        get_myupload_record() {
            ...
            axios
                ...
                .then(function (response) {
                    console.log(
                        "get_myupload_record record list: ",
                        response.data.myupload_record_list
                    );
                    ...
                    for (var ii = 0; ii < record_list.length; ii++) {
                        var idata = {
                            ...
                            upload_status_info: that.convert_upload_status_info(
                                record_list[ii].status,
                                record_list[ii].duration
                            ),
                        };
...
/* .upload-table /deep/ .el-table-column--selection .el-checkbox {
    display: none;
} */
.upload-table {
    cursor: pointer;
